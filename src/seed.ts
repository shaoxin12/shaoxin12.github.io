...
const existingArticles = [
  ...
  },
  {
    ...
    tags: [] as { zh: string; en: string }[],
    zh_title: '个人网站',
    zh_desc: '新粗野主义风格静态网站，纯 HTML/CSS/JS，零依赖。',
  ...
  },
  {
    ...
    zh_title: '五月交易复盘',
    zh_desc: '胜率提升到 65%，止损纪律执行得不错，继续优化。',
  ...
  },
  {
    ...
    tags: [{ zh: '交易', en: 'Trading' }],
    zh_title: '学习订单流分析',
    zh_desc: '开始研究 footprint chart 和成交量分布，打开了新世界。',
    zh_body: '以前看盘都是看 K 线，这周开始学订单流。Footprint chart 能看到每个价位上的买卖量对比，成交量分布图能看到哪里成交最密集。\n\n最大的收获：K 线图上看起来"放量突破"的信号，在 footprint 上看可能完全是假突破——一堆被动卖单被吃掉而已。\n\n正在看 Axia Futures 的课程，推荐给做日内交易的朋友。',
    en_title: 'Learning Order Flow Analysis',
    en_desc: 'Started studying footprint charts and volume profile.',
    en_body: "Used to just look at candlesticks, this week started learning order flow. Footprint charts show buy vs sell volume at each price level, volume profile shows where the most trading happens.\n\nThe biggest insight: what looks like a \"high volume breakout\" on candlesticks could be a complete fake-out on footprint — just a bunch of passive sell orders getting eaten.\n\nWatching Axia Futures courses. Recommended for anyone doing intraday trading.",
  },
  {
    section: 'articles',
    date: '2026-05-05',
